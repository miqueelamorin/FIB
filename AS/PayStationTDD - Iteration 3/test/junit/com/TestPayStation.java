...
public class TestPayStation {
  ...
  */
  ...
  @Test
  public void shouldAccept10And25Coins() throws IllegalCoinException {
    ps.addPayment(10);
    ps.addPayment(25);
  }
  ...
  public void receiptCanStoreValues() {
    Receipt r = new ReceiptImpl(30);
    assertEquals("Receipt can store 30 minutes", 30, r.value());
  }
  ...
  public void clearingAfterBuy() throws  IllegalCoinException{
    ps.addPayment(25);
    ps.buy();
    assertEquals(0, ps.getInsertedSoFar());
  }

  @Test
  public void cancelsResetsPayStation() throws IllegalCoinException {
    ps.addPayment(25);
    ps.cancel();
